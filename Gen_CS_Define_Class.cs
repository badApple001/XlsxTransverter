...
namespace XlsxTransverter
{
    internal class Gen_CS_Define_Class : IOutScriptHandler
    {
        ...
        public Gen_CS_Define_Class( Exporter exporter, string outDir )
        {
            ...
            string createTimeString = DateTime.Now.ToString( "G" );
            StringBuilder sb = new StringBuilder();
            sb.AppendFormat( "// Encoding: {0}\n", Encoding.UTF8.ToString() );
            sb.AppendLine( "// @Generated by XlsxTransverter" );
            sb.AppendLine( $"// Create Time: {createTimeString}" );
            ...
            for ( int i = 0; i < header.Item2.Count; i++ )
            {
                ...
                sb.AppendFormat( "\tpublic {0} {1}; // {2}", systemTypeName, header.Item3[ i ], header.Item4[ i ] );
                sb.AppendLine();
            }
            sb.AppendLine( "\tpublic int Get_ID( )\n\t{\n\t\treturn ID;\n\t}" );
